                  ...
                  <table class="w-full">
                    <thead>
                      <tr class="bg-amber-50">
                        <th class="text-left py-4 px-6 text-sm font-bold text-gray-700 border-b border-amber-200">Producto</th>
                        <th class="text-left py-4 px-6 text-sm font-bold text-gray-700 border-b border-amber-200">Descuento</th>
                        <th class="text-left py-4 px-6 text-sm font-bold text-gray-700 border-b border-amber-200">Precios</th>
                        <th class="text-left py-4 px-6 text-sm font-bold text-gray-700 border-b border-amber-200">Fechas</th>
                        <th class="text-left py-4 px-6 text-sm font-bold text-gray-700 border-b border-amber-200">Estado</th>
                        <th class="text-left py-4 px-6 text-sm font-bold text-gray-700 border-b border-amber-200">Acciones</th>
                      </tr>
                    </thead>
